...
#define I2C_STOP_READ_NOACK   0x68
...
#define I2C_REG_PRE             ( I2C0_BASE_ADDR + 0x00 )
#define I2C_REG_CTR             ( I2C0_BASE_ADDR + 0x04 )
#define I2C_REG_RX              ( I2C0_BASE_ADDR + 0x08 )
#define I2C_REG_STATUS          ( I2C0_BASE_ADDR + 0x0C )
#define I2C_REG_TX              ( I2C0_BASE_ADDR + 0x10 )
#define I2C_REG_CMD             ( I2C0_BASE_ADDR + 0x14 )

#define I2C1_REG_PRE             ( I2C1_BASE_ADDR + 0x00 )
#define I2C1_REG_CTR             ( I2C1_BASE_ADDR + 0x04 )
#define I2C1_REG_RX              ( I2C1_BASE_ADDR + 0x08 )
#define I2C1_REG_STATUS          ( I2C1_BASE_ADDR + 0x0C )
#define I2C1_REG_TX              ( I2C1_BASE_ADDR + 0x10 )
#define I2C1_REG_CMD             ( I2C1_BASE_ADDR + 0x14 )
...
#define I2C1_PRE 	REG(I2C1_REG_PRE)             
#define I2C1_CTR 	REG(I2C1_REG_CTR)             
#define I2C1_RX 	REG(I2C1_REG_RX)              
#define I2C1_STATUS REG(I2C1_REG_STATUS)       
#define I2C1_TX 	REG(I2C1_REG_TX)              
#define I2C1_CMD 	REG(I2C1_REG_CMD)            
